    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group text-justify">
                            ...
                            <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;O sistema de conferências permite que os usuários
                                criem um repositório de eventos,
                        ...
                        <div class="row">
                            <div class="form-group text-justify col-lg-6">
                                ...
                                <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;Para que você membro do React ou qualquer outra
                                    pessoa que deseja participar de
                                    algum evento (ou apresentar algum artigo nele), possa manter um controle das datas e
                                    outras informações referentes ao evento.</p>
                            </div>

                            <div class="form-group text-justify col-lg-6">
                                <h4 class="display-6 font-weight-bold">O que é o Conferências?</h4>
                                <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;Devido a necessidade de manter um controle dos
                                    futuros eventos
                                    que os membros do React apresentarão seus artigos. Para, por exemplo, não perder os
                                    prazos de
                                    submissões dos artigos. O sistema de conferências permite que os usuários criem um
                                    repositório de
                        ...
                        <div class="form-group text-justify">
                            ...
                            <p class="lead">&nbsp;&nbsp;&nbsp;&nbsp;Funciona da seguinte maneira, mesmo que você não
                                esteja cadastrado,
                                ou seja, sendo um guest. Poderá consultar os eventos cadastrados e pré-requisitos para
                                participar deles.
                                Entretanto, não poderá alterar, excluir ou criar novos eventos. Para poder ter acesso a
                                essas funcionalidades
                                o guest poderá fazer um pré-cadastro, onde será submetido a análise. Podendo ser
                                aprovado ou não para
                                participar desse sistema. Quem faz essa validação é o administrador, que é outro membro
                                desse sistema,
                                o principal na verdade. Ele que valida os usuários, os novos eventos cadastrados e etc.
                            </p>
                            <p class="lead">
                                &nbsp;&nbsp;&nbsp;&nbsp; Fora o administrador tem também o moderador, que pode editar os
                                eventos.
                                Pode adicionar novos eventos, editar os já existentes, remover, enfim ele cuidará dos
                                dados do eventos.
                ...
                <div class="card text-center" style="background-color: rgb(90,70,70);opacity: 0.9; font-size: 16px;">

                    <div style="color: white">Icons made by <a style="color: #1b1e21; font-weight: bold" href="https://www.freepik.com/" title="Freepik">Freepik</a> from <a style="color: white"
                                href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a> is licensed
                        by <a style="color: white" href="http://creativecommons.org/licenses/by/3.0/" title="Creative Commons BY 3.0"
